...
if (count($list_projects) > 0) {
	...
	foreach ($list_projects as $file) {
		...
		if (isset($gitProjects[$file])) {
			...
			$gitInfo = "<div class='project-git-info'>";
			...
			$gitInfo .= "</div>";
			// Add 1 extra line for scroll calculation: 1 for git link paragraph
			$nbProjectsLines += 1;
		}
...
<head>
  ...
  <meta name="viewport" content="width=device-width">
	...
	<link id="popupstyle" rel="stylesheet" href="wampthemes/popupmodal.css" />
